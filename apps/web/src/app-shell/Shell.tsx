...
type NavigationItem = { id: Exclude<View, "admin">; label: string; icon: IconName; count?: number };
...
const navigationItems = [...primaryNavigation, ...journeyNavigation];
