...
export function Shell({ client, user, contexts, context, onContextChange, view, onViewChange, onLogout, toast, notify, runtimeState, composerBuffer, onComposerBufferChange }: ShellProps) {
