...
- TLS válido na borda, redirect/HSTS, origem web explícita, cookies seguros e headers de segurança;
...
O ambiente local pode verificar estrutura, contratos e fixtures; não substitui o gate de staging. Até a configuração e autoridade serem fornecidas, TLS real, provider, secret authority, browsers adicionais, carga e recovery permanecem `NOT_RUN`.
