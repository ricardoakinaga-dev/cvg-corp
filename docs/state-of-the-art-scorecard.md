...
**Fotografia de evidência local:** lint, typecheck, build e static PASS; 67/67 testes unitários/integração; recovery manifest com bundle completo e rejeições de partial/stale/migration mismatch, ciphertext adulterado e chave errada; PDP target-bound provado na rota de detalhe de paciente com sessão/capability/resourceId/escopo e projeção por application service; static com 30 artefatos e 101 fontes; E2E Chromium com 22/22 casos executados PASS em 375/768/1440 e dois skips intencionais; contraste 7/7, dependency audit sem vulnerabilidades, SBOM CycloneDX, política de licenças para 193 dependências e fault/worker harness local PASS. `verify:production` validou os gates locais e o Compose estrutural com valores sintéticos, sem iniciar serviços. O workflow declara PostgreSQL/migrations/restore, E2E, segurança/visual, Dependabot, SBOM e scan Trivy de imagens; CI remoto, imagens e scan não foram executados neste host.
