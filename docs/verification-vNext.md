...
| `npm run test:e2e` | PASS — 50 pass, 4 skips | Gate local executável: Chromium + Firefox × 375/768/1440; skips intencionais de busca rápida em viewports móveis; axe separado passou 6/6 |
