...
export const APPLICATION_POLICY_REGISTRY: readonly ApplicationPolicyRule[] = [
  ...
  applicationRule("appointments.confirm", "appointments:confirm", receptionRoles, d2, "MEDIUM"),
  applicationRule("appointments.cancel", "appointments:cancel", receptionRoles, d2, "MEDIUM"),
  applicationRule("appointments.reschedule", "appointments:reschedule", receptionRoles, d2, "MEDIUM"),
  applicationRule("queue.triage", "queue:triage", receptionRoles, d2, "MEDIUM"),
  applicationRule("queue.handoff", "queue:handoff", clinicalRoles, d3, "MEDIUM"),
  applicationRule("scheduling.read", "scheduling:read", appointmentRoles, d0),
  ...
  applicationRule("diagnostics.review", "diagnostics:review", ["veterinario"], d3, "MEDIUM"),
  ...
  applicationRule("stock.inventory", "stock:inventory", ["admin", "estoque"], d2, "MEDIUM"),
  ...
  applicationRule("hospitalization.update", "hospitalization:update", ["admin", "veterinario"], d3, "MEDIUM"),
  applicationRule("hospitalization.discharge", "hospitalization:discharge", ["veterinario"], d3, "MEDIUM"),
  ...
  applicationRule("medication.update", "medication:update", ["veterinario"], d3, "MEDIUM"),
  ...
  applicationRule("knowledge.search", "knowledge:search", receptionRoles, d2),
  applicationRule("knowledge.approve", "knowledge:approve", clinicalRoles, d2, "MEDIUM"),
  applicationRule("knowledge.index", "knowledge:index", clinicalRoles, d2, "MEDIUM"),
  applicationRule("knowledge.quarantine", "knowledge:quarantine", clinicalRoles, d2, "MEDIUM"),
  ...
  applicationRule("operations.reports", "operations:reports", ["admin"], d4),
