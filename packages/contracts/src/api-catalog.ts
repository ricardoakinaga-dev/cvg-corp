...
export const API_ROUTE_CATALOG: readonly ApiRouteDescriptor[] = [
  ...
  { version: "v1", method: "POST", path: "/clinical/documents/:id/sign", operation: "clinical.sign", auth: "SESSION+CSRF", requestSchema: null, responseSchema: "ClinicalDocumentResponse", idempotent: true, deprecation: null },
