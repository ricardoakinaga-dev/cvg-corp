...
export const API_ROUTE_CATALOG: readonly ApiRouteDescriptor[] = [
  ...
  { version: "v1", method: "GET", path: "/context", operation: "context.read", auth: "SESSION", requestSchema: "ContextSelector", responseSchema: "ContextResponse", idempotent: false, deprecation: null },
  ...
  { version: "v1", method: "GET", path: "/patients/:id", operation: "patients.read-one", auth: "SESSION", requestSchema: null, responseSchema: "PatientResponse", idempotent: false, deprecation: null },
  ...
  { version: "v1", method: "POST", path: "/appointments/:id/check-in", operation: "appointments.check-in", auth: "SESSION+CSRF", requestSchema: null, responseSchema: "QueueEntryResponse", idempotent: true, deprecation: null },
  ...
  { version: "v1", method: "GET", path: "/clinical/documents", operation: "clinical.documents.read", auth: "SESSION", requestSchema: null, responseSchema: "ClinicalDocumentListResponse", idempotent: false, deprecation: null },
  { version: "v1", method: "POST", path: "/clinical/documents", operation: "clinical.documents.create", auth: "SESSION+CSRF", requestSchema: "ClinicalDocumentInput", responseSchema: "ClinicalDocumentResponse", idempotent: true, deprecation: null },
  { version: "v1", method: "POST", path: "/clinical/documents/:id/sign", operation: "clinical.documents.sign", auth: "SESSION+CSRF", requestSchema: null, responseSchema: "ClinicalDocumentResponse", idempotent: true, deprecation: null },
  { version: "v1", method: "POST", path: "/clinical/documents/:id/addenda", operation: "clinical.documents.addendum", auth: "SESSION+CSRF", requestSchema: "ClinicalAddendumInput", responseSchema: "ClinicalAddendumResponse", idempotent: true, deprecation: null },
  { version: "v1", method: "GET", path: "/diagnostics/requests", operation: "diagnostics.requests.read", auth: "SESSION", requestSchema: null, responseSchema: "DiagnosticRequestListResponse", idempotent: false, deprecation: null },
  { version: "v1", method: "POST", path: "/diagnostics/requests", operation: "diagnostics.requests.create", auth: "SESSION+CSRF", requestSchema: "DiagnosticRequestInput", responseSchema: "DiagnosticRequestResponse", idempotent: true, deprecation: null },
  ...
  { version: "v1", method: "POST", path: "/diagnostics/requests/:id/specimens", operation: "diagnostics.specimens.create", auth: "SESSION+CSRF", requestSchema: "SpecimenInput", responseSchema: "SpecimenResponse", idempotent: true, deprecation: null },
  { version: "v1", method: "POST", path: "/diagnostics/results", operation: "diagnostics.results.create", auth: "SESSION+CSRF", requestSchema: "ResultInput", responseSchema: "ResultResponse", idempotent: true, deprecation: null },
  ...
  { version: "v1", method: "POST", path: "/stock/movements", operation: "stock.movement", auth: "SESSION+CSRF", requestSchema: "StockMovementInput", responseSchema: "StockMovementResponse", idempotent: true, deprecation: null },
  ...
  { version: "v1", method: "GET", path: "/hospitalization/episodes", operation: "hospitalization.episodes.read", auth: "SESSION", requestSchema: null, responseSchema: "HospitalEpisodeListResponse", idempotent: false, deprecation: null },
  { version: "v1", method: "POST", path: "/hospitalization/episodes", operation: "hospitalization.episodes.create", auth: "SESSION+CSRF", requestSchema: "HospitalEpisodeInput", responseSchema: "HospitalEpisodeResponse", idempotent: true, deprecation: null },
  { version: "v1", method: "GET", path: "/medications/orders", operation: "medications.orders.read", auth: "SESSION", requestSchema: null, responseSchema: "MedicationOrderListResponse", idempotent: false, deprecation: null },
  { version: "v1", method: "POST", path: "/medications/orders", operation: "medications.orders.create", auth: "SESSION+CSRF", requestSchema: "MedicationOrderInput", responseSchema: "MedicationOrderResponse", idempotent: true, deprecation: null },
  { version: "v1", method: "POST", path: "/medications/orders/:id/dispense", operation: "medications.orders.dispense", auth: "SESSION+CSRF", requestSchema: "DispensationInput", responseSchema: "DispensationResponse", idempotent: true, deprecation: null },
  { version: "v1", method: "POST", path: "/medications/orders/:id/administer", operation: "medications.orders.administer", auth: "SESSION+CSRF", requestSchema: "AdministrationInput", responseSchema: "AdministrationResponse", idempotent: true, deprecation: null },
  { version: "v1", method: "GET", path: "/finance/charges", operation: "finance.charges.read", auth: "SESSION", requestSchema: null, responseSchema: "ChargeListResponse", idempotent: false, deprecation: null },
  { version: "v1", method: "POST", path: "/finance/charges", operation: "finance.charges.create", auth: "SESSION+CSRF", requestSchema: "ChargeInput", responseSchema: "ChargeResponse", idempotent: true, deprecation: null },
  { version: "v1", method: "POST", path: "/finance/payments", operation: "finance.payments.create", auth: "SESSION+CSRF", requestSchema: "PaymentInput", responseSchema: "PaymentResponse", idempotent: true, deprecation: null },
  ...
  { version: "v1", method: "POST", path: "/finance/refunds", operation: "finance.refunds.create", auth: "SESSION+CSRF", requestSchema: "RefundInput", responseSchema: "PaymentResponse", idempotent: true, deprecation: null },
  { version: "v1", method: "GET", path: "/communications", operation: "communications.read", auth: "SESSION", requestSchema: null, responseSchema: "CommunicationListResponse", idempotent: false, deprecation: null },
  { version: "v1", method: "POST", path: "/communications", operation: "communications.stage", auth: "SESSION+CSRF", requestSchema: "CommunicationInput", responseSchema: "CommunicationResponse", idempotent: true, deprecation: null },
  { version: "v1", method: "POST", path: "/communications/:id/approve", operation: "communications.approve", auth: "SESSION+CSRF", requestSchema: "CommunicationApprovalInput", responseSchema: "CommunicationResponse", idempotent: true, deprecation: null },
