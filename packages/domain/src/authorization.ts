...
export const CAPABILITY_ROLES = Object.freeze({
  ...
  "appointments:confirm": ["admin", "recepcao", "veterinario"],
  "appointments:cancel": ["admin", "recepcao", "veterinario"],
  "appointments:reschedule": ["admin", "recepcao", "veterinario"],
  "appointments:read": ["admin", "recepcao", "veterinario", "estoque", "financeiro"],
  "queue:read": ["admin", "recepcao", "veterinario"],
  "queue:triage": ["admin", "recepcao", "veterinario"],
  "queue:handoff": ["admin", "veterinario"],
  "scheduling:read": ["admin", "recepcao", "veterinario", "estoque", "financeiro"],
  ...
  "knowledge:approve": ["admin", "veterinario"],
  "knowledge:index": ["admin", "veterinario"],
  "knowledge:quarantine": ["admin", "veterinario"],
  "knowledge:search": ["admin", "veterinario", "recepcao"],
