...
const required = [
  "packages/contracts/src/index.ts", "packages/contracts/src/api-catalog.ts", "packages/domain/src/index.ts", "packages/harness/src/index.ts", "packages/agent-runtime/src/index.ts", "packages/agent-policy/src/index.ts", "packages/agent-tools/src/index.ts", "packages/auth/src/index.ts", "packages/harness-adapters/src/index.ts", "packages/deepseek-bridge/src/index.ts", "packages/config/src/index.ts", "apps/api/src/server.ts", "apps/deepseek-bridge/src/server.ts", "apps/api/src/routes/health.ts", "apps/api/src/application/agent-service.ts", "apps/api/src/application/appointment-service.ts", "apps/api/src/application/diagnostic-service.ts", "apps/api/src/application/encounter-service.ts", "apps/api/src/application/patient-service.ts", "apps/api/src/application/guardian-service.ts", "apps/api/src/application/read-services.ts", "apps/api/src/application/domain-command-service.ts", "apps/api/src/application/clinical-command-service.ts", "apps/api/src/application/export-service.ts", "apps/api/src/application/idempotency-service.ts", "apps/worker/src/main.ts", "apps/worker/src/worker.ts", "docker/worker.ts", "tsconfig.json", "apps/web/src/main.tsx", "apps/web/src/app-shell/App.tsx", "apps/web/src/state/runtime-state.ts", "apps/web/src/styles.css", "db/migrations/001_initial.sql", "db/migrations/019_runtime_scope_guards.sql", "db/migrations/020_auth_security_boundary.sql", "db/migrations/021_snapshot_revision_scope.sql", "db/migrations/022_runtime_database_role.sql", "db/migrations/023_distributed_rate_limit.sql", "db/migrations/024_external_effect_reconciliation_states.sql", "db/migrations/025_communication_approval_provenance.sql", "db/migrations/026_audit_tamper_evident_chain.sql", "db/migrations/027_append_only_audit_guard.sql", "db/migrations/028_append_only_lock_privileges.sql", "db/migrations/029_ai_turn_provenance_usage_and_dml_scope.sql", "db/migrations/030_break_glass_durable_lifecycle.sql", "db/migrations/031_worker_jobs_and_heartbeats.sql", "db/migrations/032_diagnostic_request_scope.sql", "scripts/benchmark-local.ts", "scripts/lint.ts", "scripts/pdp-boundary.ts", "scripts/verify-provider-sandbox.ts", "tests/unit/auth.test.ts", "tests/unit/pdp-coverage.test.ts", "tests/unit/worker.test.ts", "tests/unit/deepseek-bridge.test.ts", "tests/unit/domain.test.ts", "tests/integration/api.test.ts", "tests/integration/faults.test.ts", "tests/integration/provider-sandbox.test.ts", "tests/integration/worker-jobs.test.ts"
];
