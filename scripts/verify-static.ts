...
const required = [
  "README.md",
  "docs/prompt-embedded-agent-runtime-2026-09-16.md",
  ...
  "evals/golden/clinical-draft-review.json",
  "evals/golden/hospitalization-handoff.json",
  "evals/golden/prompt-injection-quarantine.json",
  "evals/golden/unauthorized-tool-denial.json",
  "evals/golden/tool-outcome-unknown.json",
  "evals/golden/safe-mode-read-only.json",
  "packages/agent-kernel/src/index.ts",
  "packages/agent-context/src/index.ts",
  "packages/agent-session/src/index.ts",
  "packages/agent-plugins/src/index.ts",
  "packages/agent-skills/src/index.ts",
  "packages/model-runtime/src/index.ts",
  "packages/model-adapters/src/index.ts",
  "packages/embedded-agent-runtime/src/index.ts",
  "packages/embedded-agent-runtime/src/profiles.ts",
  "packages/agent-runtime/src/runtime-manifest.ts",
  "packages/agent-runtime/src/disabled.ts",
  "packages/agent-runtime/src/errors.ts",
  "scripts/lib/node-tests.ts",
  "scripts/agent-evals.ts",
  ...
  "scripts/verify-agent-evals.ts",
  "scripts/verify-ai-disabled.ts",
  "scripts/verify-state-of-art.ts",
  "scripts/verify-state-of-art-external.ts",
  "scripts/verify-docs-provenance.ts",
  "scripts/verify-claims.ts",
  "tests/unit/agent-kernel.test.ts",
  "tests/unit/agent-context.test.ts",
  "tests/unit/agent-session.test.ts",
  "tests/unit/agent-plugins.test.ts",
  "tests/unit/agent-skills.test.ts",
  "tests/unit/model-runtime.test.ts",
...
if (!alertmanagerRenderer.includes("CVG_ALERTMANAGER_WEBHOOK_URL") || !alertmanagerRenderer.includes("requireTls") || !alertmanagerRenderer.includes("ALERTMANAGER_CONFIG_INVALID")) failures.push("scripts/render-alertmanager.ts: Alertmanager rendering must validate authority and TLS fail-closed");
